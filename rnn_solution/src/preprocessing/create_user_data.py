...
if __name__ == '__main__':
    ...
    prior_products = pd.read_csv(config.raw_order_products_prior_path)
    train_products = pd.read_csv(config.raw_order_products_train_path)
    ...
    user_data.to_csv(config.users_path, index=False)